...
var heroSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
  autoplay: {
    delay: 3000,
...
window.addEventListener('resize', function () {
  ...
  var isMenuHidden = menuStyle.display === 'none';
  if (isMenuHidden) {
    document.body.classList.remove('page--with-menu');
  ...
  resizeTimeout = setTimeout(function () {
    var activeContent = document.querySelector('.faq__accordion-tab--active .faq__accordion-tab-content');
    if (activeContent) {
      updateMaxHeight(activeContent);
    }
  }, 300);
});
var accordionTabs = document.querySelectorAll('.faq__accordion-tab');
...
accordionTabs.forEach(function (tab) {
  var button = tab.querySelector('.faq__accordion-tab-control');
  var content = tab.querySelector('.faq__accordion-tab-content');
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/main"], () => (__webpack_require__("./dist/js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/main"], () => (__webpack_require__("./dist/scss/main.scss")))
